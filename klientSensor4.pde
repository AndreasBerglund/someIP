...
String location = "http://www.stigmollerhansen.dk/ip.html";  
 String[] ip;
 String _ip;
...
int ypos =height/2;
 ...
 String[]  ip =  loadStrings(location);
//  println(ip[0])
_ip = ip[0];
...
println("OSCMessage "+myOscMessage + " sent to " + myBroadcastLocation + "   broadcast location is retrieved from " + location); 
